...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const resolvedName =
      state === "register" ? name.trim() : email.split("@")[0] || "User";
    ...
    setIsSeller(isAdmin || email.toLowerCase().includes("seller"));
    setShowUserLogin(false);

    // Redirect admin to seller dashboard
    if (isAdmin) {
      setTimeout(() => {
